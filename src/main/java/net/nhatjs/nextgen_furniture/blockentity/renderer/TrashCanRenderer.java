...
public class TrashCanRenderer implements BlockEntityRenderer<TrashCanBlockEntity> {
    ...
    public void render(TrashCanBlockEntity be, float tickDelta, PoseStack poseStack,
        ...
        BakedModel black = mc.getModelManager().getModel(ModelResourceLocation.inventory(NhatJSNextGenFurnitureModClient.TRASH_CAN_BLACK_EXTRA));
        BakedModel white = mc.getModelManager().getModel(ModelResourceLocation.inventory(NhatJSNextGenFurnitureModClient.TRASH_CAN_WHITE_EXTRA));
