...
public final class ModBlockEntities {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES = DeferredRegister.create(
            Registries.BLOCK_ENTITY_TYPE, NhatJSNextGenFurnitureMod.MOD_ID);

    public static final RegistryObject<BlockEntityType<LaptopBlockEntity>> LAPTOP = BLOCK_ENTITIES.register("laptop",
            () -> BlockEntityType.Builder.of(LaptopBlockEntity::new,
                    ModBlocks.LAPTOP.get()).build(null));

    public static final RegistryObject<BlockEntityType<ConsoleBlockEntity>> CONSOLE = BLOCK_ENTITIES.register("console",
    ...
    public static final RegistryObject<BlockEntityType<LightBlockEntity>> LIGHT_EXTRA = BLOCK_ENTITIES.register("light_extra",
