...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<ChairBlockEntity>> CHAIR = register("chair", EntityType.Builder.<ChairBlockEntity>of((type, world) -> new ChairBlockEntity(world), MobCategory.MISC).sized(0.0F, 0.0F).setCustomClientFactory((spawnEntity, world) -> new ChairBlockEntity(world)));
